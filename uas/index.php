                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li> <a href="#service">  Materi</a> </li>
                              <li> <a href="hari.php"> Data Akses</a> </li>
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        ...
                        <h1>AKADEMI MATERI</h1>
                        <p>Selamat datang di website akademi of materi </p>
               ...
               <div class="carousel-item">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>AKADEMI MATERI</h1>
                        <p>Selamat Membaca Dan Belajar</p>
               ...
               <div class="carousel-item">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>AKADEMI MATERI</h1>
                        <p>basic template dari web ini dari berisi home, about, tampilan web, login dan materi </p>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     ...
                     <span>Selamat datang di website akademi of materi di sini kami menyiptakan suatu website berbasis open course dimana tempat tempat materi berapada di dalam website ini dan di sini seluruh materi matakuliah berada sepenuhnya. ini sebuah website dimana semua orang dapat mengunduh materi/pembelajaran dari perkuliahan dari universitas pembangunan jaya dimana materi/perkuliahan ini bersifat open source dan dapat diunduh secara gratis . </span>
                  </div>
               </div>
            </div>
            <div class="row">
               ...
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                  <div class="service-box">
                     <figure>
                        ...
                        <span class="hoverle">
                        <a href="inf.php" class="fancybox" rel="ligthbox">TI</a>
                        </span>  
                     </figure>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                  <div class="service-box">
                     <figure>
                        ...
                        <span class="hoverle">
                        <a href="dkv.php" class="fancybox" rel="ligthbox">DKV</a>
                        </span>
                     </figure>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 thumb">
                  <div class="service-box">
                     <figure>
                        ...
                        <span class="hoverle">
                        <a href="sif.php" class="fancybox" rel="ligthbox">SI</a>
                        </span>
                     </figure>
                  </div>
               </div>
      ...
      <div id="download" class="download">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>TAMPILAN DARI HALAMAN WEBSITE INI</h2>
                     <span> </span>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div id="testimonial_slider" class="carousel slide banner-bg" data-ride="carousel">
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <img class="first-slide" src="images/shan.jpeg">
                           <div class="container">
                              <div class="carousel-caption relat">
                                 <h3>Mochammad Iqshan Augustino</h3>
                                 <span><i class="fa fa-quote-left"></i> ( foundery )<i class="fa fa-quote-right"></i></span>
                                 <p>sebuah web yang dapat dipahami oleh banyak orang, bahkan orang awam sekalipun dimana kita bisa mengakses mendapatkan ilmu secara gratis, seperti kata Namanya juga hidup. Kalau terus sama berarti tidak ada perubahan dan perubahan yang bakal didapat.</p>
                              </div>
                           </div>
                        </div>
                        <div class="carousel-item">
                           <img class="second-slide" src="images/joko.jpeg">
                           <div class="container">
                              <div class="carousel-caption relat">
                                 <h3>yulianto arief</h3>
                                 <span><i class="fa fa-quote-left"></i> ( foundery )<i class="fa fa-quote-right"></i></span>
                                 <p>sebuah web yang dapat dipahami oleh banyak orang, bahkan orang awam sekalipun dimana kita bisa mengakses mendapatkan ilmu secara gratis, seperti kata francis beacon "1 peluru dapat membunuh musuh, tapi dengan pengatahuan kita bisa mengalahkan semua kejahatan"</p>
                              </div>
                           </div>
                        </div>
               ...
               <div class="row">
                  <div class="col-lg-2 col-md-6 col-sm-12 width">
                     <div class="address">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.781479006128!2d106.7232623153839!3d-6.292424963340926!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f007dedc7de1%3A0x70288cde58f42a97!2sUniversitas%20Pembangunan%20Jaya!5e0!3m2!1sid!2sid!4v1606791806049!5m2!1sid!2sid" width="480" height="450" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-6 col-sm-12 width">
                     <div class="address">
